...
class RelatorioRepository:
    ...
    def create(titulo: str, conteudo: str) -> Relatorio:
        ...
        return Relatorio.objects.create(titulo=titulo, conteudo=conteudo)

    @staticmethod
    def update(
        relatorio: Relatorio, titulo: str = None, conteudo: str = None
    ) -> Relatorio:
    ...
    def buscar_por_titulo(titulo: str) -> QuerySet[Relatorio]:
        ...
        return Relatorio.objects.filter(titulo__icontains=titulo)

    @staticmethod
    def buscar_por_conteudo(conteudo: str) -> QuerySet[Relatorio]:
        """Busca relatórios por conteúdo."""
        return Relatorio.objects.filter(conteudo__icontains=conteudo)
