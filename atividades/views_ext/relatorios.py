...
def exportar_atividades_excel(atividades):
    ...
    for atividade in atividades:
        data.append({
            ...
            'Data de Início': atividade.data_inicio.strftime('%d/%m/%Y') if atividade.data_inicio else '',
            'Data de Término': atividade.data_fim.strftime('%d/%m/%Y') if atividade.data_fim else '',
