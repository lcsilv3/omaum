    ...
    def create(self, request):
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                response_serializer = ConfiguracaoSistemaSerializer(configuracao)
                return Response(
...
class LogAtividadeViewSet(viewsets.ModelViewSet):
    ...
    def limpar_antigos(self, request):
        ...
        try:
            ...
            return Response({"removidos": removidos, "dias": dias})
        except ValueError:
            return Response(
                {"error": "dias deve ser um número"}, status=status.HTTP_400_BAD_REQUEST
            )
        except Exception as e:
            return Response(
                {"error": str(e)}, status=status.HTTP_500_INTERNAL_SERVER_ERROR
