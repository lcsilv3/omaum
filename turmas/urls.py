...
urlpatterns = [
    ...
    path(
        "<int:turma_id>/instrutores/",
        views.atualizar_instrutores,
        name="atualizar_instrutores",
    ),
    path(
        "<int:turma_id>/remover-instrutor/<str:tipo>/",
        views.remover_instrutor,
        name="remover_instrutor",
    ),
    # URLs para gerenciamento de atividades
    path(
        "<int:turma_id>/atividades/",
        views.listar_atividades_turma,
        name="listar_atividades_turma",
    ),
    path(
        "<int:turma_id>/adicionar-atividade/",
        views.adicionar_atividade_turma,
        name="adicionar_atividade_turma",
    ),
    # URLs para frequência
    path(
        "<int:turma_id>/registrar-frequencia/",
        views.registrar_frequencia_turma,
        name="registrar_frequencia_turma",
    ),
    path(
        "<int:turma_id>/relatorio-frequencia/",
        views.relatorio_frequencia_turma,
