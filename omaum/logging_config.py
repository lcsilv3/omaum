...
class PerformanceLogger:
    ...
    def log_request_metrics(self, request_path: str, duration: float, queries_count: int, 
    ...
    def log_cache_metrics(self, operation: str, key: str, hit: bool, duration: float = None):
...
class SecurityLogger:
    ...
    def log_rate_limit_violation(self, client_id: str, path: str, limit_type: str, 
    ...
    def log_suspicious_activity(self, client_id: str, path: str, pattern: str, 
                              user_agent: str = None):
    ...
    def log_admin_access_attempt(self, client_id: str, path: str, authenticated: bool,
                               user_id: int = None):
...
class APILogger:
    ...
    def log_api_request(self, method: str, endpoint: str, user_id: int = None, 
                       params: dict = None, duration: float = None):
    ...
    def log_bulk_operation(self, operation: str, count: int, duration: float, 
...
class CeleryLogger:
    ...
    def log_task_start(self, task_name: str, task_id: str, args: tuple = None, 
                      kwargs: dict = None):
    ...
    def log_task_completion(self, task_name: str, task_id: str, duration: float, 
                          result: dict = None):
