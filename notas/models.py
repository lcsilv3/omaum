...
class Nota(models.Model):
    ...
    aluno = models.ForeignKey(
        "alunos.Aluno", on_delete=models.CASCADE, related_name="notas"
    )
    curso = models.ForeignKey(
        "cursos.Curso", on_delete=models.CASCADE, related_name="notas"
    )
    turma = models.ForeignKey(
        "turmas.Turma", on_delete=models.CASCADE, related_name="notas"
    )
