...
class NotaRepository:
    ...
    def get_by_id(self, nota_id):
        ...
        try:
            return self.model.objects.select_related("aluno", "atividade").get(
                id=nota_id
            )
    ...
    def get_by_aluno_and_atividade(self, aluno_id, atividade_id):
        ...
        try:
            return (
                self.model.objects.select_related("aluno", "atividade")
                .filter(aluno_id=aluno_id, atividade_id=atividade_id)
                .first()
            )
        except Exception as e:
            logger.error(
                f"Erro ao buscar nota do aluno {aluno_id} na atividade {atividade_id}: {e}"
            )
            raise
    ...
    def get_media_by_turma(self, turma_id):
        ...
        try:
            ...
            resultado = self.model.objects.filter(
                atividade__turma_id=turma_id
