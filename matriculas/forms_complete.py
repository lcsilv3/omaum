...
class MatriculaForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['turma'].queryset = Turma.objects.filter(ativo=True).order_by('nome')
        ...
        self.fields['data_matricula'].help_text = 'Data em que a matrícula foi realizada'
    ...
    class Meta:
        ...
        widgets = {
            ...
            'data_matricula': forms.DateInput(attrs={'type': 'date', 'class': 'form-control'}),
    ...
    def clean(self):
        ...
        if aluno and turma:
            ...
            if existing_matricula.exists():
                raise ValidationError('Este aluno já possui uma matrícula ativa nesta turma.')
