        ...
        try:
            ...
            if filtros:
                ...
                if filtros.get('data_inicio'):
                    pagamentos = pagamentos.filter(data_vencimento__gte=filtros['data_inicio'])
                if filtros.get('data_fim'):
                    pagamentos = pagamentos.filter(data_vencimento__lte=filtros['data_fim'])
            ...
            if pagamentos.exists():
                ...
                relatorio['valor_total'] = float(sum(pagamento.valor for pagamento in pagamentos))
                ...
                for pagamento in pagamentos:
                    ...
                    if (pagamento.status == 'PENDENTE' and 
