...
class PagamentoRepository:
    ...
    def get_by_id(self, pagamento_id):
        ...
        try:
            return self.model.objects.select_related('aluno', 'turma').get(id=pagamento_id)
    ...
    def get_by_aluno(self, aluno_id):
        ...
        try:
            return self.model.objects.select_related('aluno', 'turma').filter(aluno_id=aluno_id)
        except Exception as e:
    ...
    def get_by_turma(self, turma_id):
        ...
        try:
            return self.model.objects.select_related('aluno', 'turma').filter(turma_id=turma_id)
        except Exception as e:
    ...
    def get_by_status(self, status):
        ...
        try:
            return self.model.objects.select_related('aluno', 'turma').filter(status=status)
        except Exception as e:
    ...
    def get_by_aluno_turma_referencia(self, aluno_id, turma_id, mes_referencia, ano_referencia):
    ...
    def exists(self, pagamento_id):
        ...
        try:
            ...
            logger.error(f"Erro ao verificar existência do pagamento {pagamento_id}: {e}")
            raise
