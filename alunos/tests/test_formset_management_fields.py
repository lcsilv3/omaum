...
def test_formset_management_fields_present():
    ...
    assert 'name="historico-INITIAL_FORMS"' in html, "Campo INITIAL_FORMS ausente no GET"
    assert 'name="historico-MIN_NUM_FORMS"' in html, "Campo MIN_NUM_FORMS ausente no GET"
    assert 'name="historico-MAX_NUM_FORMS"' in html, "Campo MAX_NUM_FORMS ausente no GET"
    ...
    assert 'name="historico-INITIAL_FORMS"' in html, "Campo INITIAL_FORMS ausente no POST"
    assert 'name="historico-MIN_NUM_FORMS"' in html, "Campo MIN_NUM_FORMS ausente no POST"
    assert 'name="historico-MAX_NUM_FORMS"' in html, "Campo MAX_NUM_FORMS ausente no POST"
