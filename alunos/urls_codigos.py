...
urlpatterns = [
    ...
    path('tipos/<int:pk>/editar/', views_codigos.editar_tipocodigo, name='editar_tipocodigo'),
    path('tipos/<int:pk>/excluir/', views_codigos.excluir_tipocodigo, name='excluir_tipocodigo'),
    ...
    path('codigos/<int:pk>/excluir/', views_codigos.excluir_codigo, name='excluir_codigo'),
]
