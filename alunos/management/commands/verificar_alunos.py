...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f"Total de matrículas em cursos pré-iniciáticos: {matriculas_pre_iniciatico.count()}")
        ...
        self.stdout.write(f"Total de alunos ativos em cursos pré-iniciáticos: {len(alunos_pre_iniciatico)}")
        ...
        self.stdout.write(f"Total de alunos ativos que podem ser instrutores: {len(alunos_instrutores)}")
