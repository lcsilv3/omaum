...
class AtividadesAcademicasViewsTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.turma = Turma.objects.create(nome="Turma A", curso=self.curso, status="A")
...
class AtividadesRitualisticasViewsTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.turma = Turma.objects.create(nome="Turma A", status="A")
    ...
    def test_listar_atividades_ritualisticas_view(self):
        ...
        response = self.client.get(
            reverse("atividades:listar_atividades_ritualisticas")
        )
