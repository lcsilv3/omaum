...
class EstadoSimpleTest(TestCase):
    ...
    def test_estado_creation(self):
        ...
        estado = Estado.objects.create(nome="São Paulo", codigo="SP", regiao="Sudeste")
