...
class FluxoCompletoTestCase(TestCase):
    ...
    def test_fluxo_basico_sistema(self):
        ...
        if self.Matricula and self.Aluno and self.Turma:
            matricula = self.Matricula.objects.create(
                aluno=aluno, turma=turma, data_matricula=date.today()
            )
    ...
    def test_integridade_dados(self):
        ...
        if self.Curso:
            curso = self.Curso.objects.create(
                nome="Curso Integridade", descricao="Teste de integridade"
            )
        ...
        if self.Matricula and self.Aluno and self.Turma:
            ...
            self.Matricula.objects.create(
                aluno=aluno1, turma=turma, data_matricula=date.today()
            )
            self.Matricula.objects.create(
                aluno=aluno2, turma=turma, data_matricula=date.today()
            )
    ...
    def test_validacoes_negocio(self):
        ...
        if self.Curso:
            curso = self.Curso.objects.create(
                nome="Curso Validações", descricao="Teste de validações"
            )
