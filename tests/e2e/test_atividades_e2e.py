...
class TestAtividadesE2E:
    ...
    def test_criar_atividade_academica(self, browser, live_server_with_data):
        ...
        browser.get(
            f"{live_server_with_data.url}{reverse('atividades:criar_atividade_academica')}"
        )
        ...
        browser.get(
            f"{live_server_with_data.url}{reverse('atividades:listar_atividades_academicas')}"
        )
    ...
    def test_calendario_atividades(self, browser, live_server_with_data):
        ...
        browser.get(
            f"{live_server_with_data.url}{reverse('atividades:calendario_atividades')}"
        )
