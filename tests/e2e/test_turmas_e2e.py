...
class TestTurmasE2E:
    ...
    def test_listar_e_detalhar_turma(self, browser, live_server_with_data):
        ...
        browser.find_element(By.NAME, "username").send_keys("lcsilv3")
        browser.find_element(By.NAME, "password").send_keys("iG356900")
    ...
    def test_criar_turma(self, browser, live_server_with_data):
        ...
        # Removido campos inexistentes: codigo, data_inicio
