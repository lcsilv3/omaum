...
def generate_coverage_report():
    ...
    try:
        ...
        for file_path, file_data in files_data.items():
            if any(app in file_path for app in ['cursos', 'alunos', 'matriculas', 'turmas', 'presencas']):
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Execução de testes paralelos otimizados')
    ...
    parser.add_argument('--no-coverage', action='store_true', help='Não gerar relatório de cobertura')
    parser.add_argument('--smoke', action='store_true', help='Executar apenas testes de fumaça')
