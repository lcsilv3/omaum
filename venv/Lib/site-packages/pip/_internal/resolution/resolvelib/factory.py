...
class Factory:
    def __init__(
        ...
        self._installed_candidate_cache: Dict[
            str, AlreadyInstalledCandidate
        ] = {}
    ...
    def _iter_found_candidates(
        ...
        def _get_installed_candidate() -> Optional[Candidate]:
            ...
            try:
                ...
                raise InvalidInstalledPackage(
                    dist=installed_dist, invalid_exc=e
                )
    ...
    def find_candidates(
        ...
        return (
            ...
            and all(
                is_satisfied_by(req, c) for req in requirements[identifier]
            )
        )
    ...
    def _make_requirements_from_install_req(
        ...
        if not ireq.match_markers(requested_extras):
            ...
            cand = self._make_base_candidate_from_link(
                ireq.link,
                template=install_req_drop_extras(ireq)
                if ireq.extras
                else ireq,
            ...
            if cand is None:
                ...
                if ireq.extras:
                    ...
                    yield self.make_requirement_from_candidate(
                        self._make_extras_candidate(
                            cand, frozenset(ireq.extras)
                        )
                    )
    ...
    def collect_root_requirements(
        ...
        for i, ireq in enumerate(root_ireqs):
            if ireq.constraint:
                ...
                if (
                    ireq.user_supplied
                    and template.name not in collected.user_requested
                ):
    ...
    def _report_single_requirement_conflict(
        ...
        skipped_by_requires_python = (
            self._finder.requires_python_skipped_reasons()
        )
