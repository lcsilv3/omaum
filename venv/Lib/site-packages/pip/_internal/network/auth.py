...
def get_keyring_provider(provider: str) -> KeyRingBaseProvider:
    ...
    if provider in ["import", "auto"]:
        try:
            ...
            logger.warning(
                msg, exc, exc_info=logger.isEnabledFor(logging.DEBUG)
            )
...
class MultiDomainBasicAuth(AuthBase):
    ...
    def use_keyring(self) -> bool:
        ...
        # user interaction
        return self.prompting or self._keyring_provider not in [
            "auto",
            "disabled",
        ]
    ...
    def _get_keyring_auth(
        ...
        try:
            ...
            logger.debug(
                "Keyring is skipped due to an exception", exc_info=True
            )
    ...
    def _prompt_for_password(
        ...
        username = (
            ask_input(f"User for {netloc}: ") if self.prompting else None
        )
        if not username:
