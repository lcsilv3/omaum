...
class Specifier(BaseSpecifier):
    ...
    def __init__(
        self, spec: str = "", prereleases: bool | None = None
    ) -> None:
    ...
    def _compare_compatible(self, prospective: Version, spec: str) -> bool:
        ...
        prefix = _version_join(
            list(itertools.takewhile(_is_not_suffix, _version_split(spec)))[
                :-1
            ]
        )
    ...
    def _compare_greater_than(
        self, prospective: Version, spec_str: str
    ) -> bool:
        # Convert our spec to a Version instance, since we'll want to work with
        # it as a version.
        spec = Version(spec_str)
...
class SpecifierSet(BaseSpecifier):
    ...
    def contains(
        ...
        return all(
            s.contains(item, prereleases=prereleases) for s in self._specs
        )
