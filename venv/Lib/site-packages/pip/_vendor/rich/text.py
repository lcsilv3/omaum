...
class Text(JupyterMixin):
        ...
        *,
        ...
        for match in re_highlight.finditer(plain):
            ...
            if style:
                start, end = get_span()
                match_style = (
                    style(plain[start:end]) if callable(style) else style
                )
    ...
    def __rich_console__(
        ...
        tab_size: int = (
            console.tab_size if self.tab_size is None else self.tab_size
        )
    ...
    def render(self, console: "Console", end: str = "") -> Iterable["Segment"]:
        ...
        style_map = {
            index: get_style(span.style) for index, span in enumerated_spans
        }
    ...
    def append(
        ...
        if len(text):
            if isinstance(text, str):
                ...
                if style:
                    self._spans.append(
                        Span(offset, offset + text_length, style)
                    )
    ...
    def split(
        ...
        *,
        ...
        if include_separator:
            ...
            lines = Lines(
                line
                for line in self.divide(flatten_spans())
    ...
    def wrap(
        ...
        *,
        ...
        no_wrap = (
            pick_bool(no_wrap, self.no_wrap, False) or overflow == "ignore"
        )
    ...
    def detect_indentation(self) -> int:
        ...
        _indentations = {
            len(match.group(1))
            for match in re.finditer(
                r"^( *)(.*)$", self.plain, flags=re.MULTILINE
            )
        }
        ...
        try:
            indentation = (
                reduce(
                    gcd, [indent for indent in _indentations if not indent % 2]
                )
                or 1
            )
        except TypeError:
    ...
    def with_indent_guides(
        ...
        *,
        ...
        _indent_size = (
            self.detect_indentation() if indent_size is None else indent_size
        )
