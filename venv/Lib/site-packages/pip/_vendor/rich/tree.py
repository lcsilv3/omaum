    ...
    def __rich_console__(
        ...
        def make_guide(index: int, style: Style) -> Segment:
            ...
            if options.ascii_only:
                ...
                line = self.TREE_GUIDES[
                    0 if options.legacy_windows else guide
                ][index]
        ...
        while stack:
            ...
            guide_style = guide_style_stack.current + get_style(
                node.guide_style
            )
...
"""
    ...
    simple_node = node.add(
        ":file_folder: [bold yellow]Atomic", guide_style="uu green"
    )
