...
class Group:
    ...
    def __init__(
        self, *renderables: "RenderableType", fit: bool = True
    ) -> None:
...
class Console:
    ...
    def __init__(
        ...
        *,
        ...
        self.is_jupyter = (
            _is_jupyter() if force_jupyter is None else force_jupyter
        )
        if self.is_jupyter:
            if width is None:
    ...
    def is_terminal(self) -> bool:
        ...
        ) and sys.stdin.__module__.startswith("idlelib"):
    ...
    def size(self) -> ConsoleDimensions:
        ...
        if self._width is not None and self._height is not None:
            return ConsoleDimensions(
                self._width - self.legacy_windows, self._height
            )
    ...
    def get_style(
        self,
        name: Union[str, Style],
        *,
        default: Optional[Union[Style, str]] = None,
    ) -> Style:
    ...
    def rule(
        ...
        *,
        ...
        rule = Rule(
            title=title, characters=characters, style=style, align=align
        )
        self.print(rule)
        ...
        with self:
            ...
            if new_line_start:
                if (
                    len(
                        "".join(
                            segment.text for segment in new_segments
                        ).splitlines()
                    )
                    > 1
                ):
    ...
    def log(
        ...
        *objects: Any,
        ...
        with self:
            ...
            link_path = (
                None if filename.startswith("<") else os.path.abspath(filename)
            )
    ...
    def save_text(
        self, path: str, *, clear: bool = True, styles: bool = False
    ) -> None:
    ...
    def export_html(
        ...
        *,
        ...
        render_code_format = (
            CONSOLE_HTML_FORMAT if code_format is None else code_format
        )
    ...
    def export_svg(
        ...
        *,
        ...
        for y, line in enumerate(
            Segment.split_and_crop_lines(segments, length=width)
        ):
            x = 0
            for text, style, _control in line:
                ...
                if style.reverse:
                    ...
                    has_background = (
                        bgcolor is not None and not bgcolor.is_default
                    )
                    background = (
    ...
    {make_tag("rect", x=0, y=offset, width=char_width * width, height=line_height + 0.25)}
        ...
        styles = "\n".join(
            f".{unique_id}-r{rule_no} {{ {css} }}"
            for css, rule_no in classes.items()
        )
