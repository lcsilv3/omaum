...
def registrar_presenca_totais_atividades(request):
    ...
    if turma and ano and mes:
        ...
        atividades = Atividade.objects.filter(
            ...
            data_inicio__range=[primeiro_dia, ultimo_dia]
        ).distinct()
    ...
    return render(request, 'presencas/registrar_presenca_totais_atividades.html', context)
...
def registrar_presenca_confirmar(request):
    ...
    if request.method == 'POST':
        ...
        keys_to_remove = [
            ...
            'presenca_atividades_totais', 'presenca_dias_atividades', 'presenca_alunos'
        ]
