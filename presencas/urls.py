...
urlpatterns = [
    # Presenças (principal)
    path("", views.listar_presencas_academicas, name="listar_presencas"),
    path("listar/", views.listar_presencas_academicas, name="listar_presencas_academicas"),
    ...
    path("editar/<int:pk>/", views.editar_presenca_academica, name="editar_presenca_academica"),
    path("excluir/<int:pk>/", views.excluir_presenca_academica, name="excluir_presenca"),
    path("excluir/<int:pk>/", views.excluir_presenca_academica, name="excluir_presenca_academica"),
    path("detalhar/<int:pk>/", views.detalhar_presenca_academica, name="detalhar_presenca"),
    path("detalhar/<int:pk>/", views.detalhar_presenca_academica, name="detalhar_presenca_academica"),
