...
urlpatterns = [
    ...
    path(
        "editar-lote/dados-basicos/",
        editar_lote_dados_basicos,
        name="editar_lote_dados_basicos",
    ),
    path(
        "editar-lote/totais-atividades/",
        editar_lote_totais_atividades,
        name="editar_lote_totais_atividades",
    ),
    path(
        "editar-lote/dias-atividades/",
        editar_lote_dias_atividades,
        name="editar_lote_dias_atividades",
    ),
    path(
        "editar-lote/dias-atividades/ajax/",
        editar_lote_dias_atividades_ajax,
    ...
    path(
        "ajax/toggle-convocacao/", toggle_convocacao_ajax, name="toggle_convocacao_ajax"
    ),
    ...
    path(
        "ajax/atualizar-convocacao/",
        atualizar_convocacao_ajax,
        name="atualizar_convocacao_ajax",
    ),
