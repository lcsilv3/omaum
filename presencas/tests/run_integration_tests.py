...
class IntegrationTestRunner:
    ...
    def run_specific_tests(self, test_pattern, verbose=False):
        ...
        cmd = ["python", "manage.py", "test", "--pattern", test_pattern]
...
def main():
    ...
    parser.add_argument(
        "--verbose", "-v", action="store_true", help="Executar com saída detalhada"
    )

    parser.add_argument(
        "--coverage", "-c", action="store_true", help="Executar com coverage"
    )
    ...
    parser.add_argument(
        "--list", "-l", action="store_true", help="Listar módulos disponíveis"
    )
