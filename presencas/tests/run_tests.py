...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Executar testes do aplicativo presencas"
    )
    parser.add_argument(
        "--no-coverage", action="store_true", help="Executar sem cobertura"
    )
    parser.add_argument(
        "--verbosity",
        type=int,
    ...
    parser.add_argument(
        "--pattern", type=str, help="Padrão para executar testes específicos"
    )
    parser.add_argument(
        "--performance",
        action="store_true",
    ...
    success = runner.run_all_tests(
        verbosity=args.verbosity, with_coverage=not args.no_coverage
    )
