    ...
    try:
        ...
        if presencas_json:
            try:
                ...
                print(f"✅ JSON parsed com sucesso: {json.dumps(presencas_data, indent=2)}")
                    ...
                    for dia, alunos_data in dias_data.items():
                        ...
                        for cpf_aluno, presenca_info in alunos_data.items():
                            ...
                            try:
                                ...
                                print(f"✅ Criando presença: Aluno={aluno.nome}, Atividade={atividade.nome}, Data={data_presenca}")
                                ...
                                print(f"✅ Presença {'criada' if created else 'atualizada'}: {presenca_obj.id}")
        ...
        if total_presencas > 0:
            ...
            for p in PresencaAcademica.objects.filter(registrado_por='TESTE_SCRIPT'):
                print(f"   ID: {p.id} | Aluno: {p.aluno.nome} | Atividade: {p.atividade.nome}")
