...
def criar_dados_teste():
    ...
    tipo_cargo, _ = TipoCodigo.objects.get_or_create(
        nome="Cargo", defaults={"descricao": "Cargos iniciáticos"}
    )

    tipo_iniciacao, _ = TipoCodigo.objects.get_or_create(
        nome="Iniciação", defaults={"descricao": "Registros de iniciação"}
    )

    tipo_punicao, _ = TipoCodigo.objects.get_or_create(
        nome="Punição", defaults={"descricao": "Registros disciplinares"}
    )
