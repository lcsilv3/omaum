...
def main():
    parser = argparse.ArgumentParser(
        description="Retoma melhoria da qualidade do código"
    )
    parser.add_argument(
        "--auto", action="store_true", help="Aplica correções automáticas"
    )
    parser.add_argument(
        "--report-only", action="store_true", help="Apenas gera relatório"
    )
    parser.add_argument(
        "--unsafe", action="store_true", help="Aplica correções não seguras"
    )
