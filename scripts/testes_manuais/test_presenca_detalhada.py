...
def test_modelo():
    ...
    print("[OK] Modelo PresencaDetalhada importado com sucesso")
    print(f"[OK] Campos do modelo: {[f.name for f in PresencaDetalhada._meta.fields]}")

    # Verificar métodos customizados
    print("[OK] Métodos customizados:")
    print(
        f"  - calcular_percentual: {hasattr(PresencaDetalhada, 'calcular_percentual')}"
    )
    print(
        f"  - calcular_voluntarios: {hasattr(PresencaDetalhada, 'calcular_voluntarios')}"
    )
    ...
    print("\n=== RESUMO ===")
    print("[OK] Modelo PresencaDetalhada implementado com sucesso")
    print("[OK] Campos Excel replicados: C, P, F, V1, V2")
    print("[OK] Cálculos automáticos funcionando")
    print("[OK] Compatibilidade mantida com sistema atual")
