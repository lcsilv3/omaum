...
def test_js_file_exists():
    ...
    js_path = os.path.join(os.path.dirname(__file__), 'static', 'js', 'presencas', 'presenca_manager.js')
...
def test_python_syntax():
    ...
    try:
        python_path = os.path.join(os.path.dirname(__file__), 'presencas', 'views_ext', 'registro_presenca.py')
...
def main():
    ...
    if test4:
        ...
        print(f"⚠ Ainda há emojis no JS que podem causar problemas: {emojis_encontrados}")
