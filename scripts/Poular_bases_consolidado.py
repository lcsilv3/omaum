...
# --- DADOS DE AMOSTRA ---
nomes = ["Miguel", "Arthur", "Gael", "Heitor", "Theo", "Davi", "Gabriel", "Bernardo", "Samuel", "Helena", "Alice", "Laura", "Maria Alice", "Sophia", "Manuela", "Maitê", "Liz", "Cecília", "Isabella"]
sobrenomes = ["Silva", "Santos", "Oliveira", "Souza", "Rodrigues", "Ferreira", "Alves", "Pereira", "Lima", "Gomes", "Costa", "Ribeiro", "Martins", "Carvalho", "Almeida", "Lopes", "Soares", "Fernandes", "Vieira"]
    ...
    for i in range(QUANTIDADE_ALUNOS):
        ...
        try:
            Aluno.objects.create(
                cpf=gerar_cpf_unico(),
                nome=nome_aluno,
                data_nascimento=date(random.randint(1970, 2000), random.randint(1, 12), random.randint(1, 28)),
